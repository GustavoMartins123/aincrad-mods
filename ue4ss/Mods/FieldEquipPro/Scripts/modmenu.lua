-- ModMenu contract for FieldEquipPro.
--
...
return {
    ...
    settings = {
        ...
        { key = "SHOW_CHARACTER", label = "Show character", type = "bool", default = true },
        { key = "CAMERA_HEIGHT", label = "Camera height", type = "number", default = 50, min = -100, max = 200, step = 5, format = "%+.0f cm" },
